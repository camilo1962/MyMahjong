...
namespace Assets.Scripts
{
    public class Game : MonoBehaviour
    {
        ...
        [ContextMenu("Parpadeo Aleatorio")]
        ...
        [ContextMenu("Quitar Parpadeo Aleatorio")]
        ...
        void Update()
        {
            ...
            if (_isGame)
            {
                ...
                LabelStatusTime.text = string.Format("{0}:{1} | Total de pares: {2} | Fichas restantes: {3}", GameTimer.Minutes, GameTimer.Seconds, _pairCount, _tileCount);
            }
        }
